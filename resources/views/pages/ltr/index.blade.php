            ...
            <div id="product-slider" class="owl-pagination-dash owl-navigation-box">
                    ...
                    <div class="offer-detail">
                        <div class="offer-detail-inner">
                            <div class="offer-detail-content">
                                <h6>RUBIROSA PIZZA:</h6>
                                <h3>CHEESE, CRUST, OLIVES,<br />MOZARELLA, TOMATO, PARMIGIANO</h3>
                ...
                <div class="offer">
                    ...
                    <div class="offer-detail">
                        <div class="offer-detail-inner">
                            <div class="offer-detail-content">
                                <h6>BOMBA CAPRESE PIZZA:</h6>
                                <h3>MOZARELLA, TOMATO, GARLIC,<br />CHILE</h3>
                                <div class="price-huge clearfix">
                                    <div class="pull-left">
                                        <span class="price-currency">$</span><span class="price-val-1">7</span>
                                    </div>
                ...
                <div class="offer">
                    <img alt="product" src="assets/images/slider/3.jpg">
                    <div class="offer-price-small">
                        $<span class="offer-price-val1">7</span><span class="offer-price-val2">99</span>
                    </div>
                    <div class="offer-detail">
                        <div class="offer-detail-inner">
                            <div class="offer-detail-content">
                                <h6>ROASTED BEETS PIZZA:</h6>
                                <h3>POMEGRANATE, CHEESE, TURNIP,<br />WATERMELON RADISH, HAZELNUT</h3>
                                <div class="price-huge clearfix">
                                    <div class="pull-left">
                                        <span class="price-currency">$</span><span class="price-val-1">7</span>
                                    </div>
                            ...
                            <div class="banner-over">
                                <div class="centered-columns">
                                    <div class="centered-column centered-column-bottom text-center">
                                        <span class="button-red button-text-big">GET FREE RECIPE</span>
                                    </div>
                                </div>
                            </div>
                        </article>
