...
var onScrollHandler = function() {
	var newImageUrl = document.getElementById("pageLogo").src;
	var scrollTop = document.documentElement.scrollTop || document.body.scrollTop;
	if (scrollTop < 100) {
		newImageUrl = "assets/images/logo.png"
	}
	if (scrollTop > 100) {
		newImageUrl = "assets/images/logo-white.png"
	}
	document.getElementById("pageLogo").src = newImageUrl;
};
